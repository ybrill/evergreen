...
func TestModelConversion(t *testing.T) {
	...
	assert.EqualValues(testSettings.Notify.SES.AWSKey, utility.FromStringPtr(apiSettings.Notify.SES.AWSKey))
	assert.EqualValues(testSettings.Notify.SES.AWSSecret, utility.FromStringPtr(apiSettings.Notify.SES.AWSSecret))
	assert.EqualValues(testSettings.Notify.SES.AWSRegion, utility.FromStringPtr(apiSettings.Notify.SES.AWSRegion))
	...
	assert.EqualValues(testSettings.Notify.SES.AWSKey, dbSettings.Notify.SES.AWSKey)
	assert.EqualValues(testSettings.Notify.SES.AWSSecret, dbSettings.Notify.SES.AWSSecret)
	assert.EqualValues(testSettings.Notify.SES.AWSRegion, dbSettings.Notify.SES.AWSRegion)
