...
func (s *AdminRouteSuite) TestAdminRoute() {
	...
	s.EqualValues(testSettings.Notify.SES.AWSKey, settings.Notify.SES.AWSKey)
	s.EqualValues(testSettings.Notify.SES.AWSSecret, settings.Notify.SES.AWSSecret)
	s.EqualValues(testSettings.Notify.SES.AWSRegion, settings.Notify.SES.AWSRegion)
